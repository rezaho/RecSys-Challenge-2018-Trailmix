...
start = int(sys.argv[1]) * 1670

print ('Start Now 0622!')
...
small_test_war = {}
for pl in list(WAR_raw.keys())[start : start + 1670]:
...
with open('../WAR/0622/WAR_PREDICT_0622/Submission_0622_WAR_P_' + sys.argv[1] + '_NOT_COMBINED.json', 'w') as f:
	json.dump(R, f)