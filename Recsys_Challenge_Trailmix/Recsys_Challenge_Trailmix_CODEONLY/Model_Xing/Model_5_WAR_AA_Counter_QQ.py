...
start = int(sys.argv[1]) * 2000

print ('Start Now 0619!~!! : )')
...
small_test_war = {}
for elem in list(WAR.keys())[start : start + 2000]:
...
with open('../WAR/0619/WAR_PREDICT_0619/Submission_0619_WAR_P_' + sys.argv[1] + '.json', 'w') as f:
