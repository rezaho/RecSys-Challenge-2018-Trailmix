...
WAR_ALREADY_HAVE = json.load(open('../WAR/0622/Submission_0622_WAR_Already_Have.json'))

small_test_war = {}
for pl in list(WAR_raw.keys()):
    if pl not in WAR_ALREADY_HAVE:
        small_test_war[pl] = WAR_raw[pl]

del WAR_raw

print 'Length of rest ', len(small_test_war)
...
with open('../WAR/0622/WAR_PREDICT_0622/Submission_0622_WAR_REST.json', 'w') as f:
	json.dump(R, f)